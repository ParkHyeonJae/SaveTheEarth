...
INT CInput::FrameMove()	// Mouse
{
	...
	// Mouse button
	m_BtnCur[0] = m_KeyCur[VK_MBUTTON];	// Left Button
	m_BtnCur[1] = m_KeyCur[VK_LBUTTON];	// Right Button
	m_BtnCur[2] = m_KeyCur[VK_RBUTTON];	// Middle Button
...
BOOL CInput::BtnDbClk(INT nBtn)
{
	return m_BtnMap[nBtn] == EINPUT_DBCLK;
}
