...
{
	m_Sky->Draw(D2D1::Point2F(m_Pos.x, m_Pos.y), D2D1::SizeF(1.0f, 1.0f), NULL, 0.0f);
	m_Cloud->Draw(D2D1::Point2F(m_CloudPos.x, 450), D2D1::SizeF(1.0f, 1.0f), NULL, 0.0f);
	m_Mountain->Draw(D2D1::Point2F(m_MountainPos.x, 550), D2D1::SizeF(1.0f, 1.0f), NULL, 0.0f);
	m_Sun->Draw(D2D1::Point2F(1200, 150), D2D1::SizeF(1.0f, 1.0f), NULL, 0.0f);
	m_Trees->Draw(D2D1::Point2F(m_Pos.x, 700), D2D1::SizeF(1.0f, 1.0f), NULL, 0.0f);
}
